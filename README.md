...
### Mars mission
Run `ruby lib/run_mission.rb` and enter the information supplied on the **Test Input** section above line by line.

### Tests
`rspec -fd`

## Improvement suggestions
 - Validate the input to check if it is being supplied in the expected format
 - Implement collision analysis when multiple rovers are on the same plateau at the same time
 - Implement the possibility to have more than two rovers on the same mission